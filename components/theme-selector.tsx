...
const themes = [
  ...
  { key: "abyssal-dark", label: "Abyssal Harbinger (Dark)", icon: <Palette className="size-4 text-red-700" /> },
  { key: "abyssal-light", label: "Abyssal Harbinger (Light)", icon: <Palette className="size-4 text-red-400" /> },
];
